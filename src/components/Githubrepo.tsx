...
const GitHubRepoDiv: FunctionalComponent<Props> = ({ githubRepoLink }) => {
  return (
    <div style={{ display: githubRepoLink ? "flex" : "none" }} class="justify-center  m-auto mt-4">
      <a href={`${githubRepoLink}`} target="_blank" rel="noopener noreferrer" aria-label="Visit Github Repo" class="hover:scale-105 transition duration-300 ease-in-out backdrop-blur-lg">
        <div class="flex flex-row m-auto justify-center items-center gap-2 bg-white dark:bg-gray-700 rounded-xl">
          <svg
            ...
            viewBox="0 0 256 256"
            aria-hidden="true"
            stroke="url(#icon-gradient-23vukm40y)"
            fill="url(#icon-gradient-23vukm40y)"
            style="--size:2.5rem"
            class="astro-PATNJMLL m-2 -mr-2"
          >
          ...
          <h2 class="m-2 text-center font-normal sm:text-lg text-md">
            Visit Repo
          </h2>
        </div>
      </a>
